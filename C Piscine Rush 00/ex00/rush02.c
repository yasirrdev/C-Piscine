...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2025/10/12 17:14:37 by lodazzan          #+#    #+#             */
/*   Updated: 2025/10/12 17:14:55 by lodazzan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if ((countx == 0 || countx == x - 1) && (county == 0))
		ft_putchar('A');
	else if ((countx == 0 || countx == x - 1) && (county == y - 1))
		ft_putchar('C');
